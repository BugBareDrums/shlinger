...
export const Welcome = () => {
    return (
        <Window className="p-8 max-w-2xl">
            ...
            <p>this game is all about spreading the festive cheer and letting santa know whose been good and whose been bad amongst your fellow shlingers</p>
            <br/>
            <p className="text-sm">the options you have are:</p>
            <ul className="text-sm list-disc list-inside ml-2">
                <li>make a CLAIM about someone; chose who, tell all, and set the parameters for it's success or failure</li>
            ...
            <ul className="text-sm list-disc list-inside ml-2">
                ...
                <li>jump on others claims to back their claims up and ensure santa knows whose been bad</li>
            </ul>
            <br/>
